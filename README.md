...
- [algebraic-graph-duoids](./algebraic-graph/README.md) – instances for [the algebraic-graphs library](https://hackage.haskell.org/package/algebraic-graphs)
- [duoidal-categories](./categories/README.md) – duoidal extensions for [the categories library](https://hackage.haskell.org/package/categories)
- [duoids-hedgehog](./hedgehog/README.md) – testing your duoid instances
- [transformer-duoids](./transformer/README.md) – instances for [the transformers library](https://hackage.haskell.org/package/transformers)
